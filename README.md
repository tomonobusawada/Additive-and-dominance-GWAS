...
4. Association test\
   The simulated phenotypes are jointly regressed on the additive and dominance genotypes. We computed marginal association statistics using OLS: for each SNP j.
